...
1. **Login:** Students register using their college credentials.
2. **Spin:** Click the "Spin" button to rotate the wheel.
3. **Challenge:** The wheel lands on a specific topic/problem statement.
4. **Develop:** Students build the solution locally or in an IDE.
5. **Submit:** Upload the code or repository link via the submission portal.
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/ponsankar-R/wheel-of-web.git
   cd wheel-of-web
